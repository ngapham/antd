    ...
    >
      ...
      <Panel header="Game" key="1" className={styles.title_panel}>
        <Radio.Group
          ...
          defaultValue={1}
        >
          <Space direction="vertical" className={styles.btn_game}>
            <Radio value={1}>Origin</Radio>
            <Radio value={2}>Classic</Radio>
          </Space>
        </Radio.Group>
      </Panel>
      <Panel header="Class" key="2" className={styles.title_panel}>
        <ListBtn />
        <br />
      </Panel>
      <Panel header="Parts" key="3" className={styles.title_panel}>
        <Input
      ...
      <Panel header="Potential Points" key="6" className={styles.title_panel}>
        <InputNumber
          min={1}
          max={10}
          defaultValue={10}
